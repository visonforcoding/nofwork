...
class Configure
{
	...
	{
		self::$_values = array_merge(self::$_values, $config);
		return true;
	}
	 ...
	 */
	public static function configured($configDir)
	{
	...
	{
		$file = self::_getFilePath($key, true);
		$return = include $file;
		if (is_array($return)) {
			self::write($return);
		}
	...
	public static function _getFilePath($key)
	{
		return self::$configDir . DIRECTORY_SEPARATOR . $key . '.php';
	}
